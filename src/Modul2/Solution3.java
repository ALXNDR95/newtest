package Modul2;         //Допишите метод numbers(), так чтобы он выводил информацию о числах. Дается 3 числа, вывести на экран строку вида {n positive, m negative, k equal 0}.
